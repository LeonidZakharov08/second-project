...
А можно открыть директорию, в которую был установлен Git. Обычно это директория <kbd>C:\Program Files\Git\bin</kbd>. Перейдите в *bin* и запустите файл <kbd>bash.exe</kbd>.
